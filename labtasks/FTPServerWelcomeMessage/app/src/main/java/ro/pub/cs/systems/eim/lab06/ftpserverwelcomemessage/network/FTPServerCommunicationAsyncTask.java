...
public class FTPServerCommunicationAsyncTask extends AsyncTask<String, String, Void> {
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            Log.d("ceva", "altceva3ftp.ngc.com");
            //StringBuilder stringBuilder = new StringBuilder();
            if (line.contentEquals(Constants.FTP_MULTILINE_START_CODE)) {
                line = bufferedReader.readLine();
                publishProgress(line);
                Log.d("ceva", "altceva");
                while (!line.contentEquals(Constants.FTP_MULTILINE_END_CODE1) ||
                        !line.startsWith(Constants.FTP_MULTILINE_END_CODE2)) {

                    Log.d("ceva", "altceva 2ftp.ngx.com");
                    line = bufferedReader.readLine();
                    publishProgress(line);
                }
                socket.close();
